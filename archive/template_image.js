//Template for images
//Note if editing, its probably easiest to turn into .html and back again
//From raw html
// turn comments into React commens e.g. <!--foo-->   to   {/*foo*/}
// terminate img or br (there was one of each)
// replace: itemprop/itemProp class/className tabindex/tabIndex  max-height/maxHeight text-align/textAlign  readonly=/readOnly=
// style="foo: bar;" => style={{foo: "bar"}
// Look for carousel-image-wrapper and check the image inside has two good URLs (copy source didn't)
//TODO-DETAILS use this approach of templating for other modes like video

export default function template_image(item) {
